...
class Application(tk.Tk):
    def __init__(self):
        super().__init__()
        self.title("IKRAM RAMADHAN - 312110478 - UAS PENGOLAHAN CITRA")
        self.geometry("600x350")
        self.configure(bg="#000080")  # Warna latar belakang menjadi navy
        self.original_image = None
        self.processed_image = None

        self.label_title = tk.Label(self, text="--MEDIAN FILTER--",
                                    font=("Times New Roman", 14), bg="#000080", fg="white")
        self.label_title.pack(pady=(20, 10))  # Penambahan margin atas menggunakan pady

        self.frame_images = tk.Frame(self, bg="#000080")
        self.frame_images.pack()

        self.frame_left = tk.Frame(self.frame_images, bg="#000080")
        self.frame_left.pack(side=tk.LEFT, padx=10)

        self.label_original = tk.Label(self.frame_left, text="Before", bg="#000080", fg="white",
                                       font=("Times New Roman", 12))
        self.label_original.pack(pady=(10, 5))  # Penambahan margin atas menggunakan pady

        self.canvas_original = tk.Canvas(self.frame_left, width=250, height=250)
        self.canvas_original.pack()

        self.frame_right = tk.Frame(self.frame_images, bg="#000080")
        self.frame_right.pack(side=tk.LEFT, padx=10)

        self.label_processed = tk.Label(self.frame_right, text="After", bg="#000080", fg="white",
                                        font=("Times New Roman", 12))
        self.label_processed.pack(pady=(10, 5))  # Penambahan margin atas menggunakan pady

        self.canvas_processed = tk.Canvas(self.frame_right, width=250, height=250)
        self.canvas_processed.pack()

        self.frame_buttons = tk.Frame(self, bg="#000080")
        self.frame_buttons.pack(side=tk.TOP, pady=10)

        self.button_upload = tk.Button(self.frame_buttons, text="Find Photos", command=self.upload_image,
                                       bg="#FFFDD0", fg="#000080", relief=tk.RAISED, font=("Times New Roman", 12, "bold"))
        self.button_upload.pack(side=tk.LEFT, padx=5)

        self.button_process = tk.Button(self.frame_buttons, text="Get Better", command=self.process_image,
                                        bg="#FFFDD0", fg="#000080", relief=tk.RAISED, font=("Times New Roman", 12, "bold"))
        self.button_process.pack(side=tk.LEFT, padx=5)

        self.label_mse = tk.Label(self, text="MSE: ", bg="#000080", fg="white", font=("Times New Roman", 12))
        self.label_mse.pack()

        self.label_psnr = tk.Label(self, text="PSNR: ", bg="#000080", fg="white", font=("Times New Roman", 12))
